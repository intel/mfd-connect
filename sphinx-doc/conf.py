...
# MFD-Connect documentation build configuration file, created by
...
htmlhelp_basename = "mfd-connect-doc"
...
latex_documents = [
    (master_doc, "mfd-connect.tex", "MFD-Connect Documentation", "author", "manual"),
]
...
man_pages = [(master_doc, "mfd-connect", "MFD-Connect Documentation", [author], 1)]
